...
let randomNum = function(){
    let randomArray = [];
    for (let i = 0; i < 8; i++){
       let randomNumbers = Math.floor(Math.random() * 49) * 2;
    ...
    if (acikKartImg.src === secilenKartImg.src) {
      ...
      /*
        ...
        */
            ...
            if (puan === 4) {
            const kutlamaGorseli = document.getElementById("kutlama-gorseli");
            kutlamaGorseli.style.display ="block"
            setTimeout(() => {
                kutlamaGorseli.style.display = "none";
              }, 5000);
        }
